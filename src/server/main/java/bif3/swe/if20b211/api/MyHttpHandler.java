...
public class MyHttpHandler {
     ...
     *   - format_example: optionalHeader(new String[]{"Connection: ","keep-alive"},new String[]{"auth-token: ", "dh2k3l4kjjasdf8894ngfk"})
    ...
    public String POST(String path, String body, String ... args) throws IOException {
        String response = "";
        socket = new Socket(host,port);
        socket.setSoTimeout(sTimeout); //TODO Get settimeout out of this function
        SimpleBufferedWriter writer = new SimpleBufferedWriter(new OutputStreamWriter(socket.getOutputStream()));
